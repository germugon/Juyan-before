...
public class User {
	...
	public User(String account, String name, String password, Integer roleNo, String roleName) {
		super();
	...
	public String toString() {
		return "User [account=" + account + ", name=" + name + ", password=" + password + ", roleNo=" + roleNo
				+ ", roleName=" + roleName + "]";
	}
